...
function EnemyWalkState:init(enemy, dungeon)
    self.entity = enemy
...
function EnemyWalkState:update(dt)
    if love.keyboard.isDown('left') then
        ...
        if love.keyboard.isDown('up') then
            self.entity.y = math.max(MAP_RENDER_OFFSET_Y + TILE_SIZE + self.entity.height, self.entity.y - enemy_WALK_SPEED_SCROLL * dt)

        -- move in 225 degree direction
        elseif love.keyboard.isDown('down') then
            self.entity.y = self.entity.y + enemy_WALK_SPEED_SCROLL * dt
    ...
    if self.bumped then
        if self.entity.direction == 'left' then
            ...
            self.entity.x = self.entity.x - enemy_WALK_SPEED * dt
        ...
        elseif self.entity.direction == 'up' then
            ...
            -- temporarily adjust position
            self.entity.y = self.entity.y - enemy_WALK_SPEED * dt
